...
```json
{
  ...
  "model": "claude-sonnet-4-20250514",  // Examples: "gpt-4o", "deepseek-chat", "gemini/gemini-1.5-pro-latest"
  "history_length": 25,
  "mode": "creative",
...
- `model`: Model to use (optional, default: claude-sonnet-4-20250514). Examples: "gpt-4o", "deepseek-chat", "gemini/gemini-1.5-pro-latest"
