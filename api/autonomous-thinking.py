...
@messages_bp.route('/kins/<blueprint>/<kin_id>/add-message', methods=['POST'])
def add_message(blueprint, kin_id):
    """
    Endpoint to add a message to messages.json without any processing.
...
@messages_bp.route('/kins/<blueprint>/<kin_id>/channels/<channel_id>/add-message', methods=['POST'])
def add_channel_message(blueprint, kin_id, channel_id):
    """
    Endpoint to add a message to a specific channel's messages.json file
